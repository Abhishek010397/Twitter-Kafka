...
public class ElasticSearchConsumer {
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic) {
        ...
        // Deserialization is done when kafka sends bytes to consumers,consumers have to
        // take these bytes & create a string from it !
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                /**
                 * here we insert data to ElasticSearch Insert Data into ElasticSearch,takes 3
                 * parameters index,type and ID,the index will fail if index twitter doesn't
                 * exist!,xcontent is used to say we are indexing JSON Document
                 */
                IndexRequest indexRequest = new IndexRequest("twitter", // index tweet
                        "tweets", id // this is to make our consumer idempotent
